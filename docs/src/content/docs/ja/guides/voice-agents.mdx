...
Voice Agents は OpenAI の speech-to-speech モデルを使用して、リアルタイムの音声チャットを提供します。これらのモデルは音声、テキスト、ツール呼び出しのストリーミングをサポートしており、音声/電話によるカスタマーサポート、モバイルアプリでの体験、音声チャットといった用途に最適です。
...
speech-to-speech モデルを使用することで、モデルの応答後に音声を文字起こししてテキストを再度音声に変換し直す必要がなく、音声をリアルタイムで処理するモデルの能力を活用できます。
