...
Agents SDK は標準で Responses API または Chat Completions API を通じて OpenAI モデルと動作します。ただし、別のモデルを使用したい場合、[Vercel の AI SDK](https://sdk.vercel.ai/) にはこのアダプター経由で Agents SDK に取り込める多様な対応モデルがあります。
