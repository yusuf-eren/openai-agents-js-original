...
Voice Agents use OpenAI speech-to-speech models through the to provide realtime voice chat. These models support streaming audio, text, and tool calls and are great for applications like voice/phone customer support, mobile app mobile experiences, and voice chat.
...
<LinkCard
  ...
  href="/guides/voice-agents/quickstart"
