...
0. **Create a project**
   ...
   Alternatively, you can use [Stackblitz](https://stackblitz.com/github/openai/openai-agents-js/tree/examples/realtime-demo) to create a new project directly within your browser.
...
3. **Create your first Agent**
   ...
   Creating a new [`RealtimeAgent`](/openai/agents-realtime/classes/realtimeagent/) is very similar to creating a regular [`Agent`](/docs/agents).
...
- Learn how to give your voice agent:
  ...
  - [Tools](/guides/voice-agents/build#tools)
  - [Handoffs](/guides/voice-agents/build#handoffs)
  - [Guardrails](/guides/voice-agents/build#guardrails)
  - [Handle audio interruptions](/guides/voice-agents/build#audio-interruptions)
  - [Manage session history](/guides/voice-agents/build#session-history)

- Learn more about the different transport layers.

  - [WebRTC](/guides/voice-agents/transport#connecting-over-webrtc)
  - [WebSocket](/guides/voice-agents/transport#connecting-over-websocket)
  - [Building your own transport mechanism](/guides/voice-agents/transport#building-your-own-transport-mechanism)
